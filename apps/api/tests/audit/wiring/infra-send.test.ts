// Behavioral spot-tests — POST /send fires send.enqueued on all three branches
// (SMTP enqueue, scheduled, OAuth), audit-only (no activity).
...
describe('infra send (POST /send branches) audit wiring', () => {
  beforeEach(() => {
    vi.clearAllMocks()
